		...
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					...
					"items": [],
					"caption": "#ResourceString(NewsAndInsightsTab_caption)#",
					"iconPosition": "only-text",
					"visible": true
				},
				"parentName": "Tabs",
			...
			{
				"operation": "insert",
				"name": "NewsAndInsightsExpansionPanel",
				"values": {
					"type": "crt.ExpansionPanel",
					"tools": [],
					"items": [],
					"title": "#ResourceString(NewsAndInsightsExpansionPanel_title)#",
					"toggleType": "default",
					"togglePosition": "before",
					"expanded": true,
					"labelColor": "auto",
				...
				"parentName": "NewsAndInsightsTab",
				"propertyName": "items",
				"index": 0
			},
			{
				"operation": "insert",
				"name": "NewsAndInsightsGridContainer",
				"values": {
					"type": "crt.GridContainer",
					"rows": "minmax(max-content, 24px)",
					"columns": [
				...
				"parentName": "NewsAndInsightsExpansionPanel",
				"propertyName": "tools",
				"index": 0
			},
			{
				"operation": "insert",
				"name": "NewsAndInsightsTimeline",
				"values": {
					"type": "crt.Timeline",
					"items": [],
					"tools": [],
					...
					"hideTools": false,
					"masterSchemaId": "$Id",
					"caption": "#ResourceString(NewsAndInsightsTimeline_caption)#",
					"label": "#ResourceString(NewsAndInsightsTimeline_label)#",
					"filters": [],
					...
					"placeholder": "",
					"tooltip": "",
					"timelineName": "NewsAndInsightsTimeline",
					"filterValues": "$NewsAndInsightsTimeline_AllTileFilters"
				},
				"parentName": "NewsAndInsightsExpansionPanel",
				"propertyName": "items",
				"index": 0
			},
			{
				...
				"values": {
					...
					"filters": "$TimelineTile_AIInsight_Items",
					"iconPosition": "only-icon",
					"icon": "star-icon",
					"visible": true
				},
			...
			{
				"operation": "insert",
				"name": "MessageComposerSelector_hjalx2w",
				"values": {
			...
			{
				"operation": "insert",
				"name": "NewsAndInsightsTimelineFilterContainer",
				"values": {
					"type": "crt.FlexContainer",
					"items": [],
					"classes": [],
			...
			{
				"operation": "insert",
				"name": "NewsAndInsightsTimeline_TimelineFilter_Entity",
				"values": {
			...
			{
				"operation": "insert",
				"name": "NewsAndInsightsTimeline_TimelineFilter_Date",
				"values": {
			...
			{
				"operation": "insert",
				"name": "NewsAndInsightsTimeline_TimelineFilter_Owner",
				"values": {
			...
			{
				"operation": "insert",
				"name": "NewsAndInsightsTimeline_TimelineFilter_SystemMessages",
				"values": {
		...
		viewModelConfigDiff: /**SCHEMA_VIEW_MODEL_CONFIG_DIFF*/[
			{
				...
				"values": {
					...
					"NewsAndInsightsTimeline_AllTileFilters": {
						"from": [],
